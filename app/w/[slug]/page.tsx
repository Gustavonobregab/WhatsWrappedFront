...
export default function PermalinkPage({ params }: { params: { slug: string } }) {
  ...
  // Carregar dados de métricas pelo slug
  useEffect(() => {
    async function fetchMetrics() {
      try {
        ...
        const response = await fetch(`/api/v1/metrics/permalink/${slug}`)
